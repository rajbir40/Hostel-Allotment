...
export default function AllotmentGH3() {
  ...
  useEffect(() => {
    ...
    const fetchRooms = async () => {
      try {
        ...
        const filteredRooms = response.data.filter(room => room.hostel === 'GH-3');
  ...
  <div className={`main-allotment ${modalIsOpen ? 'blur-background' : ''}`}>
    <div className='hostel'>
      ...
      <div className="flex flex-row mt-5">
        <button type="button" className="grid-item text-white bg-white-700 hover:bg-white-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
          Ground Floor
        </button>
        <button type="button" className="grid-item text-white bg-white-700 hover:bg-white-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
          1st Floor
                ...
                <div className="flex justify-center gap-3">
                  {room.slice(0, 2).map((r, index) => (
                    <button
                      key={index}
                      type="button"
                      className={`text-white ${r.isAvailable ? 'bg-green-700 hover:bg-green-800 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800' : 'bg-red-700 hover:bg-red-800'} focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 h-[40px] w-[61.48px]`}

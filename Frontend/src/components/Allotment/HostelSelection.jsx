      ...
      <div className="w-1/2 flex flex-col justify-center items-center p-8 " >
        ...
        >
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
            <li>
              <a href="/allotmentBH1" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">BH-1</a>
            </li>
            <li>
              <a href="/allotmentBH2" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">BH-2</a>
            </li>
            <li>
              <a href="/allotmentBH3" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">BH-3</a>
            </li>
            <li>
